...
if TYPE_CHECKING:
    from ...tl.types import TypeStoriesStealthMode, TypeStoryItem, TypeStoryView, TypeStoryViews, TypeUser, TypeUserStories



class AllStories(TLObject):
    CONSTRUCTOR_ID = 0x519d899e
    SUBCLASS_OF_ID = 0x7e60d0cd

    def __init__(self, count: int, state: str, user_stories: List['TypeUserStories'], users: List['TypeUser'], stealth_mode: 'TypeStoriesStealthMode', has_more: Optional[bool]=None):
        """
    ...
    def from_reader(cls, reader):
        ...
        return cls(count=_count, state=_state, user_stories=_user_stories, users=_users, stealth_mode=_stealth_mode, has_more=_has_more)
